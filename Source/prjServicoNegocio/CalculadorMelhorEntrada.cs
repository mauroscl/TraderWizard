...
namespace ServicoNegocio
{
	...
	public class CalculadorMelhorEntrada
	{
		...
		public void Calcular(cIFRSimulacaoDiariaDetalhe pobjSimulacaoDiariaDetalhe, bool pblnGerouNovoAgrupadorDeTentativas)
		{
			...
			IFRSimulacaoDiaria objSimulacaoComMelhorEntradaPorAgrupadorDeTentativas = null;
			...
			IFRSimulacaoDiaria objSimulacaoComMelhorEntradaNaMesmaDataDeSaida = null;
	    ...
	    private CotacaoAbstract ConverterCotacao(IFRSimulacaoDiaria simulacaoDiariaOrigem, IFRSimulacaoDiaria simulacaoDiariaDestino)
	    {
