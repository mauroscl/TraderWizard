...
namespace prjServicoNegocio
{
	public class cCalculadorDeTentativas
	{
	    ...
	    public cCalculadorDeTentativas(ServicoDeCotacaoDeAtivo servicoDeCotacaoDeAtivo)
	    {
	    ...
	    public cTentativaVO Calcular(cIFRSimulacaoDiaria pobjSimulacaoParaCalcular, cIFRSobrevendido pobjIFRSobreVendido)
		{
			...
			cIFRSimulacaoDiaria objSimulacaoAnterior = _servicoDeCotacaoDeAtivo.BuscaSimulacaoAnterior(pobjIFRSobreVendido, pobjSimulacaoParaCalcular.DataEntradaEfetiva);
