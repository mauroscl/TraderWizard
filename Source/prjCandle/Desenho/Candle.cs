...
namespace prjCandle.Desenho
{
	...
	public class Candle
	{
		...
		public Candle(DateTime pdtmData, decimal pdecValorAbertura, decimal pdecValorFechamento, decimal pdecValorMaximo, decimal pdecValorMinimo, decimal pdecOscilacao, bool pblnMediaArmazenar)
		{
			Data = pdtmData;
