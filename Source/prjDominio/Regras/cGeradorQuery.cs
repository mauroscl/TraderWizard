...
namespace prjModelo.Regras
{
	...
	public class cGeradorQuery
	{
		...
		/// 17/12/2010 - Inclusão da média móvel de 200 e do tipo de média para indicar se devem ser usadas médias exponencias ou aritméticas
		///</alteracoes>
		public static string BackTestingIFRSemFiltroEntradaQueryGerar(string pstrCodigo, string pstrPeriodicidade, string pstrFiltroMME49, double pdblIFRValorMaximoSobrevendido, int pintOrdem, frwInterface.cEnum.enumMediaTipo pintMediaTipo, bool pblnMME21Incluir = false)
		{
